...
class Property(models.Model):
    ...
    # Additional Fields
    property_features = JSONField(blank=True, null=True)
    ad_id = models.AutoField(unique=True)
    ...
    advertiser_info = JSONField(blank=True, null=True)
    similar_properties = JSONField(blank=True, null=True)
