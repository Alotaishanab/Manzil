...
class AddPropertySerializer(serializers.Serializer):
    ...
    # Read-only field for draft status
    is_draft = serializers.BooleanField(read_only=True)

    # --- New Fields ---
    rentDuration = serializers.ChoiceField(
    ...
    floorPlan = serializers.FileField(required=False, allow_null=True)
    mainImageIndex = serializers.IntegerField(required=False, default=0)
